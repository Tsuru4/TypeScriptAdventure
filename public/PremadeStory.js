...
function constructBookSparky() {
    ...
    //Volume 1
    {
        adventureBook.constructChapter(1, "path1", ["This is the story of [Protagonist] [Surname], a brave young boy with superpowers.",
            "One day, [Protagonist]'s father pulls him and his two older brothers, [Eldest Brother] and [Second Brother], aside and brings him to the family's secret library. He shows them four books, each with hidden techniques on superpowers."], "Which book will [Protagonist] choose?", [{ label: "Fire", path: "path2Fire", icon: snowball }, { label: "Water", path: "path2Water", icon: snowball }, { label: "Air", path: "path2Air", icon: snowball }, { label: "Earth", path: "path2Earth", icon: snowball }]);
    }
    //Volume 2
    {
        adventureBook.constructChapter(2, "path2Fire", ["[Protagonist] skeptically chose fire. The book claims that fire is the most powerful element, coveted even by the gods. but when he tried to spar against his brothers, he was easily overpowered. Dumb book was all talk, but his father told him to stick with it.",
            ...
            "[Protagonist] has a new problem now. He has tried to ignore the truth his entire childhood, but he can no longer ignore reality. His dad is a supervillain."], "What should he do?", [{ label: "Fight", path: "path3Fight", icon: snowball }]);
        adventureBook.constructChapter(2, "path2Water", ["[Protagonist] reluctantly picked up the book on water powers. But he has absolutely no talent for superpowers. His older brothers both laugh at him.",
            "[Protagonist] has a new problem now. He has tried to ignore the truth his entire childhood, but he can no longer ignore reality. His dad is a supervillain."], "To be continued.", [{ label: "Fight?", path: "badpath3Water", icon: snowball }]);
    ...
    //Volume 3
    {
        adventureBook.constructChapter(3, "path3Fight", ["[Protagonist] fights desperately to stand up against his father's supervillain reign of terror. [Eldest Brother] and some of their friends join him. Using a laser pistol developed by one of his father's minions, [Protagonist] manages to hit his father's leg, but ultimately, both sides have superpower, and the other side has a lot more experience.",
            "[Protagonist] lost this battle, and in a panic, he and his allies scatter and flee."], "Who will he go with?", [{ label: "Friend", path: "path4Friend", icon: snowball }]);
    ...
    //Volume 5
    {
        adventureBook.constructChapter(5, "path5Job", ["[Protagonist] tries looking for a job, but no one in [Enormous City] will hire him.",
            ...
            "[Friend 2]'s mother gives him a part time job at the food kitchen."], "[Protagonist] has a lot of free time on his hands now. How will he spend it?", [{ label: "Work Out", path: "path6Train", icon: snowball }]);
    }
    //Volume 6
    {
        adventureBook.constructChapter(6, "path6Train", ["Although he is now hundreds of miles away from home, [Protagonist] still remembers his defeat at the hands of his father. In his free time, he anxiously practices his superpowers. And at night, when no one is watching, he prowls the streets and gets in fist fights with the local gang members.",
            ...
            "The riots slowly die down, but not everyone is appeased. A few weeks after defeating his father, our protagonist sees a girl his age being attacked by rioters."], "Will he help her?", [{ label: "Obviously", path: "path7Rescue", icon: snowball }]);
    }
    //Volume 7
    {
    ...
    //Volume 8
    {
        adventureBook.constructChapter(8, "path8Fight", ["He tries to fight back, but suddenly, this girl turns into wolf! He's caught off guard and gets bitten badly. He fights her off with a blast of his powers, when suddenly, she turns into an enourmous ape and knocks him aside! With a daze, [Protagonist] realizes that this girl can change into any animal at will. He feels a strange sense of deja vu, but he can't quite place it.",
            ...
            "This popularity doesn't come without earning some grudges, though. The newly elected mayor, [New Mayor], hates him, and says that people don't need vigilantes when the police force is perfectly capable of protecting the people."], "What should [Protagonist] do?", [{ label: "Be a Hero", path: "path9Hero", icon: snowball }]);
    ...
    //Volume 9
    {
        adventureBook.constructChapter(9, "path9Hero", ["As an official superhero, he quickly makes a name for himself as [Alter Ego]. [Alter Ego] has lots of fans, and is especially popular with the ladies, many of whom for the [Alter Ego] fan club. His biggest fans are [Girl 2], [Girl 3], and [Girl 4]",
            "[Girl 1] approaches [Protagonist] one day, and asks him on a date."], "What should he do?", [{ label: "Date", path: "path10Date", icon: snowball }, { label: "Decline", path: "path10Reject", icon: snowball }]);
    }
    //Volume 10
    {
    ...
    //Volume 11
    {
        adventureBook.constructChapter(11, "path11Bribe", ["[Alter Ego] reluctantly accepts the money. He tells himself he will use the money for good, but it still feels uncomfortable.",
            ...
            "The superheroes all retreat and vanish. Meanwhile, the fire spreads at a sickening rate."], "What should he do?", [{ label: "Rescue", path: "path12Rescue", icon: snowball }] //Options will include confronting the heroes, saving the victims, or letting the villains suffer.
        );
    }
    //Volume 12
    {
        adventureBook.constructChapter(12, "path12Rescue", ["Our hero chooses to search the building for survivors. Among the survivors, he discovers [Girl 2] shielding a baby. Her arms are horribly burned, but the baby is safe. He gets her out of the building and takes her to the hosipital as fast as he can.",
            ...
            "When she gets back, [Girl 1] asks [Protagonist] to let her be his sidekick. She doesn't have any superpowers, but she feels [Protagonist] needs an accountability partner."], "Should he allow [Girl 1] become his sidekick?", [{ label: "Accept", path: "path13Sidekick", icon: snowball }] //Other choices could include quitting or rejecting her.
        );
    }
    //Volume 13
    {
        adventureBook.constructChapter(13, "path13Sidekick", ["[Protagonist] accepts [Girl 1]'s offer. She calls in some favors with some of her uncle [King]'s connections and after a year, she has a special powersuit to help her stay safe in battle. She becomes known as [Sidekick].",
            ...
            "One day, [Alter Ego] finds [Girl 3] and [Girl 4], members of his fan club, fighting over him. They each insist that they love him most."], "Who loves him most?", [{ label: "Sidekick", path: "path14Loyalty", icon: snowball }]);
    }
    //Volume 14
    {
        adventureBook.constructChapter(14, "path14Loyalty", ["[Alter Ego] says he is happiest with [Sidekick]. This leads to an even bigger fight.",
            ...
            "A second letter arrives as well, this one addressed to [Alter Ego]."], "Should he attend?", [{ label: "Attend As Self", path: "path15Self", icon: snowball }] //Other choices are to attend as a hero, or refuse.
        );
    }
    //Volume 15
    {
        adventureBook.constructChapter(15, "path15Self", ["He arrives as himself. At the meeting, he is greeted by several familiar faces, including [Eldest Brother], [Friend 1], and [Animal Girl].",
            ...
            "In order to save Earth, [Eldest Brother] believes the best way is to conquer it, then unify it so they can stand together against the aliens. [Protagonist] isn't sure what to think of this plan."], "How will he respond to this news?", [{ label: "Do It His Own Way", path: "path16Hero", icon: snowball }] //Alternatively, he can join them.
        );
    }
    //Volume 16
    {
    ...
    //Volume 17
    {
        adventureBook.constructChapter(17, "path17Leader", ["[Invasion Leader] laughs at humanity's feeble efforts to stop him. With a wave of his hand, a ball of fire appears, and the arctic starts to melt under everyone's feet. The steam is so thick, the entire sky gets covered in clouds, blocking what little starlight remained.",
            ...
            "The battle rages for an unkkown amount of time. Eventually, the invader is exausted, and he retreats back through his portal."], "...", [{ label: "Proceed", path: "path18Victory", icon: snowball }, { label: "Retreat", path: "path18Mercy", icon: snowball }]);
