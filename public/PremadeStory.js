...
function constructBookSparky() {
    ...
    //Volume 15
    {
        const button15Hero = { label: "Do It His Own Way", path: "path16Hero", iconSrc: iconAir };
        const button15Villain = { label: "Do It Brother's Way", path: "path16Villain", iconSrc: iconEarth };
        adventureBook.constructChapter(15, "path15Self", ["He arrives as himself. At the meeting, he is greeted by several familiar faces, including [Eldest Brother], [Boy 1], and [Animal Girl].",
            ...
            "In order to save Earth, [Eldest Brother] believes the best way is to conquer it, then unify it so they can stand together against the aliens. [Protagonist] isn't sure what to think of this plan."], "How will he respond to this news?", [button15Hero, button15Villain]);
    }
    //Volume 16
    {
        ...
        adventureBook.constructChapter(16, "path16Villain", ["[Protagonist] decides to join his brother in the [Surname] Syndicate, abandoning his role as the hero [Alter Ego]. Immediately, however, [Girl 1] confronts him. He tries to explain to her, but she doesn't see his reasoning as justified.",
