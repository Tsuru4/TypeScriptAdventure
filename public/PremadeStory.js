...
function constructBookSparky() {
    ...
    //Volume 4
    {
        ...
        adventureBook.constructChapter(4, "path4Solo", ["[Protagonist] steals a small plane from his father's henchmen and escapes south. Eventually he reaches a desert city, and just in time, because the plane ran our of fuel! This place should be far beyond his father's reach!",
            ...
            "But he is still starving and broke."], "How will [Protagonist] eat tonight?", [{ label: "Steal Food", path: "path5Steal", iconSrc: iconSnowball }]);
    ...
    //Volume 6
    {
        adventureBook.constructChapter(6, "path6TrainOcean", ["Although he is now hundreds of miles away from home, [Protagonist] still remembers his defeat at the hands of his father. In his free time, he anxiously practices his superpowers. And at night, when no one is watching, he prowls the streets and gets in fist fights with the local gang members.",
            ...
            "The riots slowly die down, but not everyone is appeased. A few weeks after defeating his father, our protagonist sees a girl his age being attacked by rioters."], "Will he help her?", [{ label: "Obviously", path: "path7Rescue", iconSrc: iconSnowball }]);
        adventureBook.constructChapter(6, "path6TrainDesert", ["Although he is now well over a thousand miles from home, [Protagonist] still remembers his defeat at the hands of his father. In his free time, he anxiously practices his superpowers. And at night, when no one is watching, he prowls the dessert and gets in fist fights with the local thieves.",
            ...
            "[Protagonist] arrives in [Enormous City] just as the riots are dying down, but not everyone is appeased yet. The day he arrives, [Protagonist] sees a girl his age being attacked by rioters."], "Will he help her?", [{ label: "Obviously", path: "path7Rescue", iconSrc: iconSnowball }]);
    }
    //Volume 7
    {
    ...
    //Volume 8
    {
        adventureBook.constructChapter(8, "path8Fight", ["He tries to fight back, but suddenly, this girl turns into wolf! He's caught off guard and gets bitten badly. He fights her off with a blast of his powers, when suddenly, she turns into an enourmous ape and knocks him aside! With a daze, [Protagonist] realizes that this girl can change into any animal at will. He feels a strange sense of deja vu, but he can't quite place it.",
            ...
            "This popularity doesn't come without earning some grudges, though. The newly elected mayor, [New Mayor], hates him, and says that people don't need vigilantes when the police force is perfectly capable of protecting the people."], "What should [Protagonist] do?", [{ label: "Be a Hero", path: "path9Hero", iconSrc: iconSnowball }]);
    ...
    //Volume 9
    {
        adventureBook.constructChapter(9, "path9Hero", ["As an official superhero, he quickly makes a name for himself as [Alter Ego]. [Alter Ego] has lots of fans, and is especially popular with the ladies, many of whom form the [Alter Ego] fan club. His biggest fans are [Girl 2], [Girl 3], and [Girl 4]",
            "[Girl 1] approaches [Protagonist] one day, and asks him on a date."], "What should he do?", [{ label: "Date", path: "path10Date", iconSrc: iconSnowball }, { label: "Decline", path: "path10Reject", iconSrc: iconSnowball }]);
    }
    //Volume 10
    {
    ...
    //Volume 11
    {
        adventureBook.constructChapter(11, "path11Bribe", ["[Alter Ego] reluctantly accepts the money. He tells himself he will use the money for good, but it still feels uncomfortable.",
            ...
            "The superheroes all retreat and vanish. Meanwhile, the fire spreads at a sickening rate."], "What should he do?", [{ label: "Rescue", path: "path12Rescue", iconSrc: iconSnowball }] //Options will include confronting the heroes, saving the victims, or letting the villains suffer.
        );
    }
    //Volume 12
    {
