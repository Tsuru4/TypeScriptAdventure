...
function constructBookSparky() {
    ...
    //Volume 5
    {
        adventureBook.constructChapter(5, "path5Job", ["[Protagonist] tries looking for a job, but no one in [Enormous City] will hire him.",
            ...
            "[Friend 2]'s mother gives him a part time job at the food kitchen."], "[Protagonist] has a lot of free time on his hands now. How will he spend it?", [{ label: "Work Out", path: "path6Train", iconSrc: iconSnowball }]);
    }
    //Volume 6
    {
