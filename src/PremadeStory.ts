...
function constructBookSparky():Book
{
    ...
    //Volume 5
    {
        const button5TrainOcean:button = {label:"Work Out", path:"path6TrainOcean", iconSrc:iconSnowball};
        const button5TrainDessert:button = {label:"Work Out", path:"path6TrainDesert", iconSrc:iconSnowball};
        adventureBook.constructChapter(
            5, "path5Job",
    ...
    //Volume 7
    {
        const button7Fight:button = {label:"Fight Back",path:"path8Fight", iconSrc:iconSnowball};
    ...
    //Volume 9
    {
        const button9Date:button = {label:"Date",path:"path10Date", iconSrc:iconSnowball};
        const button9Reject:button = {label:"Decline",path:"path10Reject", iconSrc:iconSnowball}
        adventureBook.constructChapter(
            9, "path9Hero",
    ...
    //Volume 13
    {
        ...
        adventureBook.constructChapter(
            ...
            [" once mentioned a new supervillain in [Enormous City] whose only ability was healing. Her name was [Raven Angel], and she is often seen hanging around [Animal Girl]."],
            "To be continued.",
            []
        );
        ...
        adventureBook.constructChapter(
            13, "path13TreatHero",
            ["One of the superheroes who was fighting [Big Gang] earlier can create an all purpose healing balm with a wave of her staff. Of course, there is a huge catch. She's one of the superheroes who caused this mess."],
            "To be continued.",
            []
        );
