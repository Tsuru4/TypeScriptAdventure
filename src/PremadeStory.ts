...
function constructBookSparky():Book
{
    ...
    adventureBook.constructChapter(
        ...
        ["[Protagonist] reluctantly picked up the book on water powers. But he has absolutely no talent for superpowers. His older brothers both laugh at him.",
            "[Protagonist] has a new problem now. He has tried to ignore the truth his entire childhood, but he can no longer ignore reality. His dad is a supervillain."],
        "To be continued.",
        [{label:"Fight?", path:"badpath3Water"}]
    );
    ...
    adventureBook.constructChapter(
        ...
        [{label:"Work Out", path:"path6Train"}]
    );
    ...
    adventureBook.constructChapter(
        ...
        [{label:"Fight Back",path:"path8Fight"}, {label:"Run Away",path:"path8Run"}]
    );
    ...
    adventureBook.constructChapter(
        ...
        [{label:"Be a Hero",path:"path9Hero"}]
    );
    ...
    adventureBook.constructChapter(
        ...
        "What should he do?",
        [{label:"Rescue",path:"path12Rescue"}]//Options will include confronting the heroes, saving the victims, or letting the villains suffer.
    );
    ...
    adventureBook.constructChapter(
        ...
        [{label:"Accept",path:"path13Sidekick"}]//Other choices could include quitting or rejecting her.
    );
    ...
    adventureBook.constructChapter(
        ...
        "Who loves him most?",
        [{label:"Sidekick",path:"path14Loyalty"}]
    );
    ...
    adventureBook.constructChapter(
        ...
        [{label:"Do It His Own Way",path:"path16Hero"}]//Alternatively, he can join them.
    );
    ...
    adventureBook.constructChapter(
        ...
        "...",
        [{label:"Proceed",path:"path18Victory"}]
    );
